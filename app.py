...
columns = ['Option Type', 'Instrument Key', 'LTP', 'Bid Price', 'Bid Qty', 'Ask Price', 'Ask Qty', 'Volume', 'OI', 'Prev OI', 'OI Change',
           'Call OI Change | Calculated', 'Put OI Change | Calculated', 'Sentiment', 'Trend', 'Delta', 'Gamma', 'Vega', 'Theta', 'IV',
           'PCR', 'Sentiment Condition', 'Vol OI Analysis', 'Call Sum | Calculated', 'Put Sum | Calculated', 'Options Flow Diff | Calculated']
table_data = []
